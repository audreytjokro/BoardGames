...
public class TicTacToeBoard extends Board{
   ...
   public boolean isFull() {
      // returning true if marked = number of rows * number of columns in 2D array
   ...
   public boolean checkWinner() {
      return (board[0][0] == board[0][1] && board[0][0] == board[0][2]) || // first row same
             (board[1][0] == board[1][1] && board[1][0] == board[1][2]) || // second row same
             (board[2][0] == board[2][1] && board[2][0] == board[2][2]) || // third row same
             (board[0][0] == board[1][0] && board[0][0] == board[2][0]) || // first column same
             (board[0][1] == board[1][1] && board[0][1] == board[2][1]) || // second column same
             (board[0][2] == board[1][2] && board[0][2] == board[2][2]) || // third column same
             (board[0][0] == board[1][1] && board[0][0] == board[2][2]) || // diagonal row same
             (board[0][2] == board[1][1] && board[0][2] == board[2][0]);  // diagonal row same
   }
